...
%token SQUARE_BRACKET_LEFT SQUARE_BRACKET_RIGHT PARENTHESIS_LEFT PARENTHESIS_RIGHT CURLY_BRACKET_LEFT CURLY_BRACKET_RIGHT 
...
postfix_expression: primary_expression
                  ...
                  | postfix_expression SQUARE_BRACKET_LEFT expression SQUARE_BRACKET_RIGHT
                        { printf("postfix-expression ------> postfix-expression [ expression ]\n"); }
                  | postfix_expression PARENTHESIS_LEFT argument_expression_list_opt PARENTHESIS_RIGHT
                  ...
                  | postfix_expression DECREMENT
                        { printf("postfix-expression ------> postfix-expression --\n"); }
                  | PARENTHESIS_LEFT type_name PARENTHESIS_RIGHT CURLY_BRACKET_LEFT initializer_list CURLY_BRACKET_RIGHT
                        { printf("postfix-expression ------> ( type-name ) { initializer-list }\n"); }
                  | PARENTHESIS_LEFT type_name PARENTHESIS_RIGHT CURLY_BRACKET_LEFT initializer_list COMMA CURLY_BRACKET_RIGHT
                        { printf("postfix-expression ------> ( type-name ) { initializer-list , }\n"); }
                  ;
...
unary_expression: postfix_expression
                ...
                | SIZEOF PARENTHESIS_LEFT type_name PARENTHESIS_RIGHT
...
cast_expression: unary_expression
               ...
               | PARENTHESIS_LEFT type_name PARENTHESIS_RIGHT cast_expression
...
enum_specifier: ENUM identifier_opt CURLY_BRACKET_LEFT enumerator_list CURLY_BRACKET_RIGHT
                    { printf("enum-specifier ------> enum identifier-opt { enumerator-list }\n"); }
              | ENUM identifier_opt CURLY_BRACKET_LEFT enumerator_list COMMA CURLY_BRACKET_RIGHT
                    { printf("enum-specifier ------> enum identifier-opt { enumerator-list , }\n"); }
              | ENUM IDENTIFIER
...
direct_declarator: IDENTIFIER
                 ...
                 | PARENTHESIS_LEFT declarator PARENTHESIS_RIGHT
                       { printf("direct-declarator ------> ( declarator )\n"); }
                 | direct_declarator SQUARE_BRACKET_LEFT type_qualifier_list_opt assignment_expression_opt SQUARE_BRACKET_RIGHT
                       { printf("direct-declarator ------> direct_declarator [ type-qualifier-list-opt assignment-expression-opt ]\n"); }
                 | direct_declarator SQUARE_BRACKET_LEFT STATIC type_qualifier_list_opt assignment_expression SQUARE_BRACKET_RIGHT
                       { printf("direct-declarator ------> direct_declarator [ static type-qualifier-list-opt assignment-expression ]\n"); }
                 | direct_declarator SQUARE_BRACKET_LEFT type_qualifier_list STATIC assignment_expression SQUARE_BRACKET_RIGHT
                       { printf("direct-declarator ------> direct_declarator [ type-qualifier-list static assignment-expression ]\n"); }
                 | direct_declarator SQUARE_BRACKET_LEFT type_qualifier_list_opt MULTIPLY SQUARE_BRACKET_RIGHT
                       { printf("direct-declarator ------> direct_declarator [ type-qualifier-list-opt * ]\n"); }
                 | direct_declarator PARENTHESIS_LEFT parameter_type_list PARENTHESIS_RIGHT
                       { printf("direct-declarator ------> direct_declarator ( parameter-type-list )\n"); }
                 | direct_declarator PARENTHESIS_LEFT identifier_list_opt PARENTHESIS_RIGHT
...
initializer: assignment_expression
           ...
           | CURLY_BRACKET_LEFT initializer_list CURLY_BRACKET_RIGHT
                 { printf("initializer ------> { initializer-list }\n"); }
           | CURLY_BRACKET_LEFT initializer_list COMMA CURLY_BRACKET_RIGHT
                 { printf("initializer ------> { initializer-list , }\n"); }
           ;
...
designator: SQUARE_BRACKET_LEFT constant_expression SQUARE_BRACKET_RIGHT
...
compound_statement: CURLY_BRACKET_LEFT block_item_list_opt CURLY_BRACKET_RIGHT
...
selection_statement: IF PARENTHESIS_LEFT expression PARENTHESIS_RIGHT statement
                   ...
                   | SWITCH PARENTHESIS_LEFT expression PARENTHESIS_RIGHT statement
                         { printf("selection-statement ------> switch ( expression ) statement\n"); }
                   ;

iteration_statement: WHILE PARENTHESIS_LEFT expression PARENTHESIS_RIGHT statement
                         { printf("iteration-statement ------> while ( expression ) statement\n"); }
                   | DO statement WHILE PARENTHESIS_LEFT expression PARENTHESIS_RIGHT SEMICOLON
                         { printf("iteration-statement ------> do statement while ( expression ) ;\n"); }
                   | FOR PARENTHESIS_LEFT expression_opt SEMICOLON expression_opt SEMICOLON expression_opt PARENTHESIS_RIGHT statement
                         { printf("iteration-statement ------> for ( expression-opt ; expression-opt ; expression-opt ) statement\n"); }
                   | FOR PARENTHESIS_LEFT  declaration expression_opt SEMICOLON expression_opt PARENTHESIS_RIGHT statement
